          ...
          <div class="mt-6 border-t border-gray-100">
            <dl class="divide-y divide-gray-100">
              ...
              <div class="mt-6 flex items-center justify-center mr-6 gap-x-6">
                <a href="/admin/title/"><button type="button" class="text-sm font-semibold leading-6 text-gray-900">Cancel</button></a>
                  
                  <x-admin-link href='/admin/title/edit/{{$title->id}}'>  Edit Title</x-admin-link> 
                </div>
            </dl>
          </div>
        </div>
