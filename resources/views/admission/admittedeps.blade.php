<x-admission-role>
    ...
    <form method="POST" action="{{route('admission.admittedep')}}">
        @csrf
            ...
            <div class="mt-6 border-t border-gray-100">
                ...
                <div class="flex flex-col">
                        ...
                        <div class="overflow-hidden">
                            ...
                            <thead
                              ...
                              <tr>
                                ...
                                <th scope="col" class="px-6 py-4 text-lg uppercase"> Manage Admitted Students  </th>
                    ...
                    <div class="mt-6 flex items-center mb-4 justify-center mr-6 gap-x-6">
                          ...
                          <x-form-button>View Admission Lists</x-form-button>
                        </div>
