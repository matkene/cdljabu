                          ...
                          <table
                            ...
                            <thead
                              ...
                              <tr>
                                ...
                                <th scope="col" colspan="5"  class="px-6 py-4">Lists of Printed Admission Letters </th>
                              ...
                              <tr>
                                ...
                                <th scope="col" class=" px-6 py-4">Printed Date</th>
                            ...
                            <tbody>
                                ...
                                <td class="whitespace-nowrap  px-6 py-4 font-medium">{{$appl->schoolname}}</td>
                                <td class="whitespace-nowrap  px-6 py-4 font-medium">{{$appl->printslip}}</td>
