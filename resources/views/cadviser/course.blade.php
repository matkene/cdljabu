<x-course-adviser-role>
    ...
    <div>
      ...
      <thead
        ...
        <tr  class="border-b border-neutral-200 dark:border-white/10">
          ...
          <th scope="col" colspan="10"  class="px-6 py-4 text-base">STUDENT COURSE REGISTRATION </th>
    ...
    <table class="min-w-full text-left text-sm font-light text-surface dark:text-white">
      ...
      <tr  class="border-b border-neutral-200 dark:border-white/10">
       ...
       <th class="border border-black-300 whitespace-nowrap  px-6 py-4 font-medium">SEMESTER</th>
   ...
   <td class="border border-black-300 whitespace-nowrap  px-6 py-4 font-medium">{{$num++}}</td>
    ...
    <td class="border border-black-300 whitespace-nowrap  px-6 py-4 font-medium">{{$result->semester}}</td>
