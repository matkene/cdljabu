                            ...
                            <table
                              ...
                              <tbody>
                                <?php $total = 0;?>
                                  ...
                                  <td class="whitespace-nowrap  px-6 py-4 font-medium">{{$appl->sprogramme}} </td>
                              ...
                              <td class="whitespace-nowrap  px-6 py-2 font-medium">
                                  ...
                                  <input type="hidden" name="term" value="{{$appl->term}}">
                                  <button type="submit" class="bg-cyan-600 hover:bg-cyan-900  text-white rounded">
                                      View Registration
                                  </button>
                                  </form>
