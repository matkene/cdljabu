...
<div id="sidebar" class="lg:block hidden bg-white w-64 h-screen fixed rounded-none border-none">
    ...
    <div class="p-4 space-y-4">
        <!--  -->
        <a href="/cadviser/dashboard" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 rounded-lg text-white bg-gradient-to-r from-sky-600 to-cyan-400">
            <i class="fas fa-home text-white"></i>
            <span class="-mr-1 font-medium">Dashboard</span>
        </a>
       
        
        <a href="{{url("/cadviser/dashboard/report")}}" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-500 group">
