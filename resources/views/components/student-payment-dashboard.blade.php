    ...
    <div class="bg-white p-4 rounded-lg xs:mb-4 max-w-full shadow-md lg:w-[65%]"> 
        ...
        <div class="flex flex-wrap justify-between h-full">
            ...
            <div class="flex-1 bg-gradient-to-r from-cyan-400 to-cyan-600 rounded-lg flex flex-col items-center justify-center p-4 space-y-2 border border-gray-200 m-2">
                ...
                <p class="text-white"><a href="/student/methods">Make Payments</a></p>
            </div>

            <!-- Transaction  -->
            <div class="flex-1 bg-gradient-to-r from-cyan-400 to-cyan-600 rounded-lg flex flex-col items-center justify-center p-4 space-y-2 border border-gray-200 m-2">
                <i class="fa-solid fa-signal text-white text-4xl"></i>
                <p class="text-white"><a href="/student/paystatus">Transactions Status</a></p>
            </div>

            <!-- Receipt <i class="fa-solid fa-receipt"></i> -->
            <div class="flex-1 bg-gradient-to-r from-cyan-400 to-cyan-600 rounded-lg flex flex-col items-center justify-center p-4 space-y-2 border border-gray-200 m-2">
                <i class="fa-solid fa-receipt text-white text-4xl"></i>
                <p class="text-white"><a href="/student/receipt">Receipts</a></p>
            </div>
