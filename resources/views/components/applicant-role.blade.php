...
<head>
    ...
    <title>CDL JABU - APPLICANT</title>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      <header class="flex justify-between items-center bg-white p-4">
        ...
        <div class="flex space-x-8 text-lg font-bold text-blue-500">
            CENTRE FOR DISTANCE LERANING </br>JOSEPH AYO BABALOLA UNIVERISTY <br/>
            Km 25, Akure Ilesha Road, Ikeji-Arakeji Osun State <br/>
            08150979585, 08150979544, 08150979545
