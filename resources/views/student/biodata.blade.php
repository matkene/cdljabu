  ...
  <x-flash-message/> 
          ...
          <div class="sm:col-span-6 mt-2">                 
              ...
              <thead
                ...
                <tr>                    
                  <th scope="col" colspan="2"  class="px-6 py-4 text-base"> PERSONAL INFORMATION</th>
                </tr>
               </thead>
              <tbody> 
              ...
              <thead
                ...
                class="border-b border-neutral-200 bg-neutral-50 font-medium dark:border-white/10 dark:text-neutral-800">
                <tr>                    
                  <th scope="col" colspan="2"  class="border border-black-300 px-6 py-4"> NEXT-OF-KIN DETAILS</th>
                </tr>
               </thead>
