        ...
        @csrf 
            ...
            <div class="sm:col-span-6 mt-2">                 
                ...
                <thead
                  ...
                  <tr>                    
                    <th scope="col" colspan="2"  class="px-6 py-4 text-base">EDIT BIODATA - PERSONAL INFORMATION</th>
                  </tr>
                 </thead>
                <tbody> 
                  ...
                  class="border-b border-neutral-200 bg-neutral-50 font-medium dark:border-white/10 dark:text-neutral-800">
                  <tr>                    
                    <th scope="col" colspan="2"  class="border border-black-300 px-6 py-4"> CONTACT INFORMATION</th>
                  </tr>
                 </thead>
                    <tr class="border-b border-neutral-200 dark:border-white/10">                        
                        <td class="border border-black-300 whitespace-nowrap  px-6 py-4 font-medium">
                 ...
                 value="{{ $student['address']}}">
                      ...
                      <tr class="border border-black-300 border-b border-neutral-200 dark:border-white/10">                        
                ...
                <thead
                  class="border-b border-neutral-200 bg-neutral-50 font-medium dark:border-white/10 dark:text-neutral-800">
                  <tr>                    
                    <th scope="col" colspan="2"  class="border border-black-300 px-6 py-4"> PROGRAMME OF STUDY</th>
                  </tr>
                 </thead>
                    <tr class="border-b border-neutral-200 dark:border-white/10">                        
                        <td class="border border-black-300 whitespace-nowrap  px-6 py-4 font-medium">
                  ...
                  class="border-b border-neutral-200 bg-neutral-50 font-medium dark:border-white/10 dark:text-neutral-800">
                  <tr>                    
                    <th scope="col" colspan="2"  class="px-6 py-4 border border-black-300"> NEXT-OF-KIN DETAILS</th>
                  </tr>
                 </thead>
