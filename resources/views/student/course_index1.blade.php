<x-student-role>
    <form method="POST" action="{{route('student.coursep')}}">
      @csrf                  
      ...
      <div>
        ...
        <thead
          ...
          <tr>
            ...
            <th scope="col" colspan="2"  class="px-6 py-4">PRINT COURSE REGISTRATION CONSOLE </th>
      ...
      <div class="mt-6 flex items-center mb-4 justify-center mr-6 gap-x-6">
          ...
          <x-form-button> Click to Print </x-form-button>
        </div>
